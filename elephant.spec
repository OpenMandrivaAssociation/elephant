...
# clipboard causes crashing, filed bug issue on github
for provider in calc desktopapplications files providerlist runner symbols todo unicode websearch; do
